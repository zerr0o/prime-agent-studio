...
**Version 3.7.0** · [Download the Windows x64 installer](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.7.0/Prime-Agent-Studio_3.7.0_x64-setup.exe) · [Release history](docs/en/changelog.md).
