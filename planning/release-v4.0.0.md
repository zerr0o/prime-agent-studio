...
**Download this preview manually from the assets below.** The current in-app beta updater does not discover a prerelease tagged exactly `v4.0.0` without a `-beta.N` suffix. This publication does not replace stable 3.8.1.
...
- This exact `v4.0.0` preview requires manual installation, as noted above.
