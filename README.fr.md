...
**Version 3.7.0-beta.2** · [Télécharger l’installateur bêta Windows x64](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.7.0-beta.2/Prime-Agent-Studio_3.7.0-beta.2_x64-setup.exe) · [Historique des versions](docs/changelog.md).
