...
- Le menu de l’icône propose **Ouvrir le Studio**, **Préférences du Studio** et **Quitter l’application**. Quitter ferme Tauri, mais laisse le serveur et les agents travailler.
...
Si l’application installée et le serveur actif ont des versions différentes, le lancement au premier plan affiche **Terminer la mise à jour du Studio**, même après une installation manuelle. Il indique le moteur requis, propose sa préparation puis son activation. **Plus tard** garde l’ancien serveur sans arrêter ses agents. Le secours natif reste accessible depuis l’icône près de l’horloge lorsque l’ancien serveur ne possède pas encore le panneau intégré. Depuis un navigateur ou un téléphone, le panneau permet de consulter les versions et les nouveautés. Avec un accès en écriture, vous pouvez confirmer une demande de mise à jour : l’application Windows doit être active et aucun agent ne doit travailler. L’installation et le redémarrage restent exécutés par l’application Windows, qui vérifie à nouveau les conditions. Le pilotage courant du Studio depuis mobile reste disponible pendant le travail des agents.
