...
Run [Prime-Agent-Studio_3.6.0_x64-setup.exe](https://github.com/zerr0o/prime-agent-studio/releases/download/v3.6.0/Prime-Agent-Studio_3.6.0_x64-setup.exe). Installation is limited to your Windows user and offers Start menu and desktop shortcuts. Node.js is included. The installer installs WebView2 when needed; this component may require an Internet connection.
